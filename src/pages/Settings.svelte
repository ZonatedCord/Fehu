      ...
      {#if ollamaGuide}
        <div class="guide-box">
          ...
          <div class="ai-prompt-box">
            <p class="ai-prompt-text">Devo configurare Ollama sul mio computer per farlo funzionare con un'app desktop chiamata Fehu (tracker finanziario locale) che lo usa per categorizzare automaticamente le spese tramite un modello LLM locale. Aiutami a: 1) installare Ollama sul mio sistema operativo, 2) scegliere e scaricare un modello leggero ma capace per classificazione testuale (consigliami tu il migliore disponibile oggi considerando RAM disponibile e velocità — modelli come llama3.2, qwen2.5, mistral o phi4-mini sono buone basi), 3) verificare che funzioni correttamente. Dimmi prima qual è il mio sistema operativo per darti le istruzioni giuste.</p>
            <button class="btn-copy-ai" onclick={() => copy("Devo configurare Ollama sul mio computer per farlo funzionare con un'app desktop chiamata Fehu (tracker finanziario locale) che lo usa per categorizzare automaticamente le spese tramite un modello LLM locale. Aiutami a: 1) installare Ollama sul mio sistema operativo, 2) scegliere e scaricare un modello leggero ma capace per classificazione testuale (consigliami tu il migliore disponibile oggi considerando RAM disponibile e velocità — modelli come llama3.2, qwen2.5, mistral o phi4-mini sono buone basi), 3) verificare che funzioni correttamente. Dimmi prima qual è il mio sistema operativo per darti le istruzioni giuste.", 'ollama-ai')}>
